...
from .views import CustomerUserList, CustomerUserDetail, CurrentUser, LogoutView, RegisterView, EmailLoginView, GuestLoginView, GuestLogoutView, ActivityPingView, ValidateTokenView
